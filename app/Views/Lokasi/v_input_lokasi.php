        ...
        <div class="row">
            ...
            <?php echo form_open_multipart('Lokasi/insertData')?>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" name="lokasi_kejadian" value="<?= set_value('lokasi_kejadian') ?>">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" name="jml_muatan" value="<?= set_value('jml_muatan') ?>">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" name="jenis_muatan" value="<?= set_value('jenis_muatan') ?>">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" name="asal" value="<?= set_value('asal') ?>">
                    <p class="text-danger"><?= isset($errors['asal']) == isset($errors['asal']) ? validation_show_error('asal') : '' ?></p>
                </div>

                <div class="form-group">
                    <label>Bendera Kapal</label>
                    <input class="form-control" name="bendera_kapal"value="<?= set_value('bendera_kapal') ?>">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" name="pelanggaran"value="<?= set_value('pelanggaran') ?>">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" name="kerugian_negara" value="<?= set_value('kerugian_negara') ?>">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" name="instansi_penangkap" value="<?= set_value('instansi_penangkap') ?>">
