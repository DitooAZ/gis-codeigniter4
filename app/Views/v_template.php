...
<html lang="en">
    ...
    <a class="navbar-brand ps-3" href="#">Informasi Pelanggaran Laut 2024</a>
    <!-- Navbar Search-->
...
<?php 
            ...
            // Menampilkan teks sesuai dengan level pengguna
            if ($level == 1 || $level == 3) {
                // Jika level 1 atau level 2, tampilkan Logout
                echo '<div class="dropdown-item text-center">' . ($level == 1 ? 'Admin' : 'User') . '</div>';
                echo '<li><hr class="dropdown-divider" /></li>';
                echo '<li><a class="dropdown-item" href="' . base_url('auth/logout') . '">Logout</a></li>';
            } else {
                // Jika level 3, tampilkan Login
                echo '<li><a class="dropdown-item" href="' . base_url('auth/login') . '">Login</a></li>';
                echo '<li><hr class="dropdown-divider" /></li>';
                echo '<li><a class="dropdown-item" href="' . base_url('auth/register') . '">Register</a></li>';
            }
?>
        </ul>
    </li>
                        ...
                        -->
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href=<?= base_url('Lokasi/index')?>>Pemetaan Lokasi Kejadian </a>
                                    <a class="nav-link" href=<?= base_url('Lokasi/tabelData')?>>Tabel Data Kejadian</a>
                                    <a class="nav-link" href=<?= base_url('Lokasi/grafik')?>>Grafik</a>
                                </nav>
                            </div>
                            <?php } ?>
                            
                            <?php if (session()->get('level')==1) {?>
                            <div class="sb-sidenav-menu-heading">Khusus Admin</div>
                            <a class="nav-link collapsed" href="#" data-bs-toggle="collapse" data-bs-target="#collapseLayouts" aria-expanded="false" aria-controls="collapseLayouts">
                ...
                <footer class="py-4 bg-light mt-auto">
                    <div class="container-fluid px-4">
                        <div class="d-flex align-items-center justify-content-between small">
                            <div class="text-muted">Copyright &copy; AnanditoAZ 2024</div>
                        </div>
                    </div>
                </footer>
            </div>
